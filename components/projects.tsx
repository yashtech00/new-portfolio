...
export const projectsData = [
  {
    ...
    image: ["https://media.licdn.com/dms/image/v2/D562DAQEn2kiOb_mgdg/profile-treasury-image-shrink_800_800/B56ZWtCt3XGUAY-/0/1742364926826?e=1774792800&v=beta&t=u5fgjokx3asqSVsmEkmwsCj1WvB9ZVSjwZQOzVbxheM","https://media.licdn.com/dms/image/v2/D562DAQFsszVAwKU2zg/profile-treasury-image-shrink_800_800/B56ZWs_32XGUAk-/0/1742364180673?e=1774792800&v=beta&t=ZagFUVsmi7u9ahqhQgrfkCNlvXe4_ipuOC19kvq_4_o","https://media.licdn.com/dms/image/v2/D562DAQHpfPAI-ATRwA/profile-treasury-image-shrink_800_800/B56ZWs_zIJHQAo-/0/1742364161608?e=1774792800&v=beta&t=aGlG_Mz7mezdZQ96oq-ByPps3pgBnfCppNd4T5gEBDY","https://media.licdn.com/dms/image/v2/D562DAQG1paSeyUx-AQ/profile-treasury-image-shrink_800_800/B56ZWs_vUcGsAY-/0/1742364145912?e=1774792800&v=beta&t=aYUlgyxTixLFQeEY2sKlhBVAX8jC23W-37FfmASZNSo"],
    github: "#",
    demo: "#",
    tech: [
      "Next.js",
...
function ProjectRow({ project, reverse }: any) {
  return (
    <div>
        <p className="text-2xl font-bold mb-4">My Projects <span className="text-blue-500">~ Those late night grind</span></p>
